describe("End to end", () => {
  it("should highlight each segment when mouse is hovered", () => {
    cy.visit("/home");
    cy.get(".DevOps-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Data.Engineering-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Quality.Engineering-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Cloud.Platforms-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Integration-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Backend-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Frontend-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
    cy.get(".Mobile-segment")
      .trigger("mouseover")
      .should("have.css", "fill", "rgba(235, 35, 109, 0.3)")
      .and("not.have.css", "fill", "transparent");
    cy.wait(2000);
  ...
  it("should hover over CircleCI icon and check that icon pop up appears and displays technology text", () => {
    cy.visit("/home");
