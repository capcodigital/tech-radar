...
Scenario: AWS content appears as expected
    ...
    And the user should see "Availability zones are distinct separate facilities within a region. AWS availability zones enable replication of applications and data to protect against single point of failure. This allows the design of high availability and redundancy in your applications."
